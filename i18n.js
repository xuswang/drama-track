...
const MESSAGES = {
  en: {
    ...
    'action.refreshEps': 'Refresh episodes',
    ...
    'lookup.hint': 'Search AniList, MyAnimeList & Bangumi for total episodes (great for Chinese donghua)',
    ...
    'lookup.refreshProgress': 'Updating episodes {current}/{total}…',
    'lookup.refreshDone': 'Episode counts updated ({count} changed)',
    'lookup.refreshNone': 'Episode counts are up to date',
    'form.cancel': 'Cancel',
    'form.save': 'Save',
    ...
    'card.edit': 'Edit',
    'card.delete': 'Delete',
    'card.restore': 'Resume watching',
    'list.archiveEmpty': 'No archived shows',
  ...
  zh: {
    ...
    'lookup.search': '搜索集数',
    'lookup.hint': '从 AniList / MyAnimeList / Bangumi 查询总集数（适合国产动漫，MAL 对长篇连载更准确）',
    ...
    'lookup.refreshProgress': '正在更新集数 {current}/{total}…',
    'lookup.refreshDone': '集数已更新（{count} 部有变化）',
    'lookup.refreshNone': '集数已是最新',
    'form.cancel': '取消',
    'form.save': '保存',
    'status.watching': '在看',
